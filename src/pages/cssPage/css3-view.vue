    ...
    <dl>
      ...
      <dd v-highlight>
        ...
        　21. X::pseudoElement
          ...
          ie6 ie7不支持display：inline-block的解决办法：
          ...
          overflow:hidden;
          Ie6不兼容max-width和min-width:的解决方法：
          ...
          <p class="ie"> 
          <span style="display:block;display:none;">嘿嘿，小子竟然也用Firefox，蓝色文字。</span> 
